...
method of dependency pairs\index{termination!dependency pair}
...
Let us note \(\W{x_1 \prec x_2}{2p+1}\) the former cost and \(\W{x_2
...
cost is the \emph{external path length}\index{tree!external path
...
Technically, let us note \(\B{\fun{i2wb}}{n}\) the cost of any call
