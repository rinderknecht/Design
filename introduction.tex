...
the white bead next to it.'' The goal of this game is to end up with
...
with the \emph{factorial}\index{factorial} of~\(n\), that is, \(1
...
arguments of a function is called \emph{arity}\index{functional
...
can be further reduced. These two constraints define a \emph{purely
  functional language}
\citep{Hughes_1989,Hinsen_2009}\index{functional language}. Notice
