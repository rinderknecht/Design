...
%
\usepackage[bindingoffset=0cm,a4paper,centering,textheight=200mm,textwidth=120mm,includefoot,includehead]{geometry}
...
%\includeonly{introduction,linear,arborescent}
