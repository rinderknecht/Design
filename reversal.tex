...
\end{itemize}
The basis is quickly found:
\begin{equation*}
  \fun{rev}_0(\fun{rev}_0(\el))
...
\begin{equation*}
  ...
  \fun{rev}_0(\fun{cat}(\fun{rev}_0(s),[x])) \qquad (\fun{rev}_0),
\end{equation*}
...
\begin{array}{@{}r@{\;}l@{\;}l@{\;\;}r@{}}
  ...
  & \xrightarrow{\smash{\alpha}} \fun{rev}_0(t)
  & (\fun{cat})\\
...
& (\fun{cat}). %\multicolumn{1}{r@{}}{(\fun{cat}) \Box}
\end{array}
\end{equation*}
...
the associativity\index{stack!concatenation!associativity} of
